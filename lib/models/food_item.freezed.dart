...
class _$FoodItemImpl implements _FoodItem {
  ...
  @override
  String toString() {
    return 'FoodItem(id: $id, name: $name, image: $image, link: $link, content: $content)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, image, link, content);
...
abstract class _FoodItem implements FoodItem {
  const factory _FoodItem(
      ...
      @HiveField(4) final String? content}) = _$FoodItemImpl;
